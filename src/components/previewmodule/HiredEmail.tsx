    ...
    <div className="bg-gray-50 min-h-screen flex items-center justify-center px-4 py-10">
      <div className="max-w-xl w-full bg-white rounded-xl overflow-hidden shadow-lg">
        ...
        <div className="bg-indigo-500 text-white text-center py-10 rounded-t-xl">
          <h2 className="text-xl font-semibold">Hired Application</h2>
        </div>
...
/>
          ...
          <p className="mb-4 text-justify">
            Our team was very impressed by your profile and performance during the selection process, and we’re excited to welcome you on board. Further details regarding your offer letter, onboarding process, and joining formalities will be shared with you shortly. Please confirm your acceptance by replying to this email.
          </p>

          <p className="mb-4 text-justify">
            We look forward to working with you and are confident you’ll make a great addition to our team.
          </p>

          <p className="text-sm text-gray-500 mb-2 text-justify">
            We are committed to helping you achieve your academic and research goals. If you have any questions or need assistance, our{" "}
